...
**Actuator** class is the center point of the framework - it can be consider as a digital twin of the physical actuator. All the most importnat properties of an actuator need to be defined in the object of this class - **type** (LRA, ERM etc.), **rated voltage**, **peak voltage**, **resonant frequency** (for LRA) and an **Actuator Driver** instance that controls it.  
...
//TODO  IMAGE WITH PHYSICAL ACTUATOR AND DATASHEET ON LEFT AND  PROPERTIES ON THE RIGHT

### Actuator Driver
Need to mention Haptic Layer file
...
``` cpp
// DRV2605L evaluation board contains multiple DRV2605L drivers. Therefore the driver ID need to be specified
int driverID = 0;
int driverGoPin = 12;
