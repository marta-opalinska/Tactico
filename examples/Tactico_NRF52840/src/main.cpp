...
void loop() {
  ...
  //   // ----------------- GPIO DRIVER SETUP
  //   // pin that is connected to the actuator and supports Pulse
  //   Width-Modulation int driverPinGPIO = 22;
  ...
  //   int driverID_1 = 0;
  //   // the pin connected to DRV2605LEVM-MD board that triggers the haptic
  //   effects int driverGoPin = 12;
  ...
  //   // the standard DC voltage for the actuator
  //   float ratedVoltage_LRA = 3.5;
  //   // the maximum allowable DC voltage
  //   float overdriveVoltage_LRA = 3.5;
  //   // LRA actuator resonant frequency (can be found in the datasheet)
  //   int resonantFrequency_LRA = 200;
  //   // optional - custom name will be prited alongside logs refering to the
  //   // actuator
  //   std::string customName_LRA = "myLRA_1";

  //   std::shared_ptr<ActuatorLRA> actuator_LRA =
  //   std::make_shared<ActuatorLRA>(
  ...
  //   // This step is not parallel. Step's constructor field 'isParallel' is
  //   FALSE
  ...
  //       std::make_shared<ActuatorStep>(actuator_ERM_2,
  //       pattern_DRV2605L_BUZZ);

  //   bool isParallel_yes = true;
  //   // step that combines actuator_ERM_2 with pattern_DRV2605L_CLICK - this
  //   step
  //   // is run in parallel
  //   std::shared_ptr<ActuatorStep> s_ERM_2_DRV2605L_CLICK_PARALLEL =
  //       std::make_shared<ActuatorStep>(actuator_ERM_2,
  //       pattern_DRV2605L_CLICK,
  //                                      isParallel_yes);
  ...
  //   //  Remember that the order in which you write Actions will be the order
  //   of
  //   //  playing them
  ...
  //   while (1) {
  //     // a function to reset pre-run configuration of all the actuators in
  //     the
