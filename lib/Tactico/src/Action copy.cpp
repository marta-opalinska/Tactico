...
//         break;
//         // else {
//         //   // actuators that does not support preconfuguration cannot be
//         //   played
//         //   // with external trigger. Therefore, cannot be run simutanously so
//         //   // the slot number need to be increased.
//         //   slotCounter++;
//         // }
...
//         //       // set waveform for DRV2605L driver
//         //       auto actuatorDriverDRV2605LEVM(
//         //           std::static_pointer_cast<ActuatorDriverDRV2605LEVM>(
//         //               actuatorDriver));
//         //       actuatorDriverDRV2605LEVM->setWaveform(slotCounter,
//         //                                              actuatorStep->m_pattern);
//         //       // adding goPins to trigger for a play - multiple actuator can
//         //       // be on the same goPin
//         //       m_goPins.push_back(actuatorDriverDRV2605LEVM->getGoPin());
...
//       }
//       case eWaitStep: {
//         // TODO slot counter counted twice when else driver and wait!!!
//         //  slot number need to be incremented - before eWaitStep action steps
//         //  can be performed simutanously (triggering GO pin). That does no
//         //  include PMW pattern with ActuatorDriverGPIO - currently steps with
//         //  this type of pattern cannot be performed simutanously.
//         // slotCounter++;
...
//         // timeFromLastPlay[actuatorStep]

//         // for (auto actuator : this->m_actuators) {
//         //   auto actuatorDriver = actuator->getDriver();
//         //   if (actuatorDriver->m_needsPreconfigration) {
//         //     auto waitStep(std::static_pointer_cast<WaitStepImpl>(step));
//         //     switch (actuatorDriver->getType()) {
//         //       case eDRV2505L_EVBOARD: {
...
//         //                 actuatorDriver));
//         //         // setting wait time
//         //         actuatorDriverDRV2605LEVM->setWait(slotCounter,
//         //                                            waitStep->m_waitTime);
//         //         // adding goPins to trigger for a play - multiple
//         //         actuator
//         //         // can be on the same goPin
//         //         m_goPins.push_back(actuatorDriverDRV2605LEVM->getGoPin());
//         //         break;
//         //       }
//         //       default: {
